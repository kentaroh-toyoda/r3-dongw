...
if ($os =~ /MSWin32/) {
  ...
  $si   = "..\\bi\\win32\\si.exe";
	...
	$diff = "../diff_r3/linux/diff_dmt.exe";
	$rmtd = "../rmtd_r2/linux/rmtd_dmt.exe";
	$bi   = "../bi/linux/bi.exe";
	$si   = "../bi/linux/si.exe";
}
...
&excmd("gcc ../diff_r3/diff_dmt.c -o ../diff_r3/linux/diff_dmt.exe");
&excmd("gcc ../rmtd_r2/rmtd_dmt.c -o ../rmtd_r2/linux/rmtd_dmt.exe");
...
while (<cc>) {
  ...
  if ($_) {
  	...
  	$dir1 = "../benchmarks/$rs[1]";
		...
		&excmd("$diff $dir1/build/telosb/main-n.raw $dir2/build/telosb/main-n.raw ../benchmarks/delta-$no.raw > ../benchmarks/dmt/native_diff-$no.log");
		&excmd("$rmtd $dir1/build/telosb/main-n.raw $dir2/build/telosb/main-n.raw 8 > ../benchmarks/dmt/native_rmtd-$no.log");
