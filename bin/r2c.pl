...
while (<cc>) {
  ...
  if ($_) {
    ...
    &excmd("$xdiff $dir1/build/telosb/crela.raw $dir2/build/telosb/crela.raw 5 ../benchmarks/xrmtd-delta-crela-$no.raw >../benchmarks/r2c-crela-$no.log");
		...
		&fix("$dir1/build/telosb/si-bi1.txt", "$dir1/build/telosb/si-n.txt");
		&fix("$dir2/build/telosb/si-bi1.txt", "$dir2/build/telosb/si-n.txt");
		...
		print out "$no $bmk1 $bmk2 $deltasize $cr $psi_bi1 $outold $outnew $gzsize_out $cr_out $relaold $relanew $gzsize_rela $cr_rela\n";
