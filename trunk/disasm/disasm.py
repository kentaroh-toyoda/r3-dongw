...
def getAddressingMode(asad, word):
    if asad == 'as':
        ...
        if word & 0x0080 == 0x0000:
            ...
            if word & 0x000f >= 0x0003 or word & 0x000f == 0x0001: #wei: word & 0x000f >= 0x0004:
                admode = "IndexedMode"
...
def disassemble(map):
    ...
    while bytes :
        ...
        if ophash["op"] == "double" :
            if ( reginame == '4'or reginame == '4' or
            ...
            strAddMode = getAddressingMode('as',word & 0x0030)
#           print strAddMode
            destList = getAddModeStr(strAddMode)
            destRegname = getRegister(word & 0x000f)
            ...
            if strAddMode == "RegisterMode":
                ...
                Src = getSrcStr(destList, reginame)
